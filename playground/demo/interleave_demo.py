...
if __name__ == "__main__":
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(args.model_path, args.model_base, model_name, args.load_8bit, args.load_4bit, attn_implementation="sdpa", cache_dir=args.cache_dir)
    our_chatbot = None
    # import pdb;pdb.set_trace()
    try:
